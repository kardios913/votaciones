...
<html lang="es">
  <?php include '../util/heap.php';?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8 col-md-offset-2">
                          ...
                          <div class="box box-danger">
                              ...
                              <!-- /.box-header -->
                              <!-- form start -->
                           <form role="form" method="POST" action="RegistrarJornda.php" id="registroJornada">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="inicioC"  required>
                                            </div>
                                            <div class="form-group">
    ...
    $('#registroJornada').submit(function (e) {
        var data = new FormData(this); //Creamos los datos a enviar con el formulario
        $.ajax({
            url: '../php/RegistrarJornda.php', //URL destino
            data: data,
