                                ...
                                <h2 class="login-tab" style="color:#fff"> <span>Administrador<span></h2>
                                            ...
                                            <div class="tabs-content">
                                                ...
                                                <div id="login-tab-content" class="active">
                                                    <form class="login-form" action="" method="post" id="validarHash">
                                                        <input type="mail" class="input" name="mailA" id="user_login"  Value="<?php echo $mail;?>" readonly >
                                                     ...
                                                     <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="fg-line" id="resultvalidarHash">
                                            ...
                                            <script>
                                                // VALIDANDO DATOS
                                                $('#validarHash').submit(function (e) {
                                                    var data = new FormData(this); //Creamos los datos a enviar con el formulario
                                                    $.ajax({
                                                        url: 'validarHash.php', //URL destino
                                                        data: data,
                                                        processData: false, //Evitamos que JQuery procese los datos, daría error
                                                        contentType: false, //No especificamos ningún tipo de dato
                                                        type: 'POST',
                                                        success: function (data) {
                                                            $('#resultvalidarHash').html(data);
                                                        }
                                                    });
