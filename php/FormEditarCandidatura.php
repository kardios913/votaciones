                        ...
                        <section class="content-header">
                            <h1>
                                <center>
                                    ...
                                    <small>Editar Candidatura</small>
                                </center>
                            </h1>
                            <br>
                            <?php if (isset($msg)) { ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <div class="box box-danger">
                                        ...
                                        <!-- /.box-header -->
                                        <!-- form start -->
                                        <form role="form" method="POST" action="EditarCandidatura.php" id="EditarCandidatura" enctype="multipart/form-data">

                                            <div class="box-body">
                                                <div class="alert alert-warning alert-dismissable">
                                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                                    <strong>¡Cuidado!</strong> si actualizas tu candidatura <br>
                                                    esta entrara nuevamente en revision.
                                                </div>
                                                <div class='form-group'>
                                                    <label>Codigo</label>
                                                    <input type='text' name='codigo' class='form-control' value='<?php echo $_GET['cod'] ?>' readonly>
                                                </div> 
                                                <div class='form-group'>
                                                    <label>Jornada</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" title="Use este Campo para escribir sus propuestas <br>y el porque quiere ser electo" name="descripcion" required>
